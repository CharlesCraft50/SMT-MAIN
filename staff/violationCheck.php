...
<body>
  <div class="text-center d-flex flex-column align-items-center">
    ...
    <!-- Timer and Instruction Message -->
    <div id="timer"></div>
    <div id="instruction">Please face the camera with your uniform or ID visible.</div>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
      startCameraButton.click(); // Auto-start on page load
    });
  </script>
